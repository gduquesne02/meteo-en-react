    ...
    <SafeAreaView>
      ...
      <Card style={styles.card}>
        <Card.Content>
          ...
          <Text style={styles.h3}>{route.params[0].weather[0].description}</Text>
          ...
          <Text></Text>
          <Text style={styles.h2}>Longitude : {route.params[0].coord.lon}</Text>
          <Text style={styles.h2}>Latitude : {route.params[0].coord.lat}</Text>

          <Text></Text>
          <Text style={styles.h3}>Photo de {nomVille} : </Text>
          <Text></Text>
        </Card.Content>
        <Card.Cover style={styles.imageVille} source={{ uri: route.params[1].suggested_searches[0].thumbnail}} />
      </Card>
      </ScrollView>
    </SafeAreaView>
  );
